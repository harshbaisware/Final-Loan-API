...
{
    public class LoanAppliedDetailsEducationController : ApiController
    {
        ...
        public HttpResponseMessage Put(int id, [FromBody] LoanAppliedDetail loanapplieddetail)
        {
            try
            {
                using (TrustyloandbEntities entities = new TrustyloandbEntities())
                {
                    ...
                    {
                        entity.Edu_ID = loanapplieddetail.Edu_ID;
                        entity.Edu_Amount = loanapplieddetail.Edu_Amount;
                        entity.Edu_Rate = loanapplieddetail.Edu_Rate;
                        entity.Edu_Tenure = loanapplieddetail.Edu_Tenure;
                        entity.Edu_Emi = loanapplieddetail.Edu_Emi;
                        entity.Edu_Last_Emi = loanapplieddetail.Edu_Last_Emi;
                        entity.Edu_Interest = loanapplieddetail.Edu_Interest;
